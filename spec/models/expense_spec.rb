...
describe Expense do
  ...
  context "validation" do
    ...
    it 'raises an error when saving with a null transacting user' do
      ...
      expect{ expense.save! }.to raise_error(ActiveRecord::RecordInvalid, "Validation failed: Transacting user can't be blank, Transacting user must be a shareholder to record an expense (internal error)")
    end
